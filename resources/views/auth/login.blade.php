...
<head>
    ...
    <title>Login Admin - Pengaduan Surakarta</title>
            ...
            <div class="bg-slate-100 px-8 py-8">
                ...
                <form method="POST" action="{{ route('admin.login.submit') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="email" value="{{ old('email') }}" class="w-full rounded-md border border-slate-300 bg-white px-4 py-3 focus:ring-2 focus:ring-[#294d7b] outline-none" placeholder="admin@surakarta.go.id" required>
                    </div>

                    <div>
                        <label class="block text-xs font-bold uppercase tracking-wide text-slate-700 mb-1">Password</label>
                        <div class="relative">
                            <input id="passwordInput" type="password" name="password" class="w-full rounded-md border border-slate-300 bg-white px-4 py-3 pr-12 focus:ring-2 focus:ring-[#294d7b] outline-none" placeholder="Masukkan password" required>
